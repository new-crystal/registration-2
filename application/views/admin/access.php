        ...
        <div class="content">
            <div class="panel panel-flat">
                ...
                <form action="/admin/access" id="qr_form" name="qr_form"
                    ...
                    <button class="w-[150px] h-[50px] bg-slate-300 mt-20 hover:bg-slate-400 active:bg-slate-500"
                        type="button" id="open">새창</button ton>
            ...
            <div class="footer text-muted mt-20">
                © 2022. <a href="#">온라인 학술대회</a> by <a href="http://themeforest.net/user/Kopyov"
                    target="_blank">(주)인투온</a>
            </div>
        </div>
    </div>
</div>
