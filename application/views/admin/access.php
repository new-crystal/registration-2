...
<form action="/admin/access" id="qr_form" name="qr_form"
    ...
    <div class="w-2/5 flex flex-col items-center justify-center">
        <h1 class="text-5xl mt-20">QR CODE 입력 </h1>

        <h6 class="text-3xl mt-20">커서를 텍스트박스 안에 놓고 QR 코드 스캐너를 사용하세요.</h6>
        <input id="qrcode" name="qrcode" class="w-[400px] h-[50px] mt-20 p-3" />
        <button class="w-[150px] h-[40px] bg-slate-300 mt-20" type="submit" id="submit">등록</button>
    </div>
