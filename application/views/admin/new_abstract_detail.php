            ...
            <section class="panel form-horizontal">
                <div class="panel-body" style="background-color:#ffffff">
                    <div class="form-group form-inline">
                        ...
                        <div class="col-sm-10">
                            <?php echo $base['TITLE'];?>
                            <!--input class="form-control" type="text" value="<?php //echo $base['TITLE'];?>" name="TITLE" id="TITLE"-->
                        </div>    
                    </div>
                    <div class="form-group form-inline">
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--input class="form-control" type="text" value="<?php //echo $base['AUTHOR_NAME'];?>" name="AUTHOR_NAME" id="AUTHOR_NAME"-->
                        </div>    
                    </div>
                    <div class="form-group form-inline">
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--input class="form-control" type="text" value="<?php //echo $base['AUTHOR_AFFILIATIONS'];?>" name="AUTHOR_AFFILIATIONS" id="AUTHOR_AFFILIATIONS"-->
                        </div>    
                    </div>
                    <div class="form-group form-inline">
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--textarea class="form-control" name="BACKGROUND" id="BACKGROUND" rows="4"><?php //echo $base['BACKGROUND'];?></textarea-->
                        </div>    
                    </div>
                    <div class="form-group form-inline">
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--textarea class="form-control"  name="METHOD" id="METHOD" rows="4"><?php //echo $base['METHOD'];?></textarea-->
                        </div>    
                    </div>
                    <div class="form-group form-inline">
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--textarea class="form-control" name="RESULT" id="RESULT" rows="4"><?php //echo $base['RESULT'];?></textarea-->
                        </div>    
                    </div>
                    <div class="form-group form-inline">
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--textarea class="form-control" name="CONCLUSIONS" id="CONCLUSIONS" rows="4"><?php //echo $base['CONCLUSIONS'];?></textarea-->
                        </div>    
                    </div>
                    <div class="form-group form-inline">
