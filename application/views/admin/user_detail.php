                    ...
                    <div class="panel-body">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" value="<?php echo $item['registration_no']; ?>" name="registration_no" id="lucky">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group form-inline">
                                ...
                                <div class="col-sm-10"><input class="form-control" type="text" value="<?php echo $item['member_type']; ?>" name="member_type" id="type1">
                            ...
                            <div class="form-group form-inline">
                                ...
                                <div class="col-sm-10"> <input class="form-control" type="text" value="<?php echo $item['occupation_type']; ?>" name="occupation_type" id="type2">
                                </div>
                            </div>
                            <div class="form-group form-inline">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input class="form-control" type="text" value="<?php echo $item['name_kor']; ?>" name="nick_name" id="nick_name">
                                </div>
                            </div>
                            <div class="form-group">
