...
-->
                                    <input class="form-control" type="text" value="<?php echo $item['type1']; ?>"
                                        name="type1" id="type1">
...
-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="<?php echo $item['etc1']; ?>"
                                        name="ln" id="ln">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="<?php echo $item['ln']; ?>" name="ln"
                                        id="ln">
                                </div>
                            </div>
                            <div class="form-group">
