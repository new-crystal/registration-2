                        ...
                        <div class="detail_table">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td> <input class="form-control" type="text" value="<?php echo $item['etc2']; ?>" name="etc2" id="etc2"></td>
                                </tr>
                                <tr>
                                    <th>등록시간</th>
                            ...
                            <table>
                                ...
                                <tr>
                                    <th>Occupation</th>
                                    <td> <input type="text" class="form-control" value="<?php echo $item['occupation_type']; ?>" name="occupation_type" id="ln"></td>
                                </tr>
                                <tr>
                                    <th>Occupation (Others)</th>
                                    <td> <input type="text" class="form-control" value="<?php echo $item['occupation_other_type']; ?>" name="occupation_other_type" id="ln"></td>
                                </tr>
                                <tr>
                                    <th>Category</th>
                                ...
                                <tr>
                                    ...
                                    <td><input class="form-control" type="text" name="etc4" value="<?php echo $item['etc4']; ?>" id="etc4">
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="detail_table">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input class="form-control" type="text" value="<?php echo $item['special_request_food']; ?>" name="special_request_food" id="special_request_food">
                                    </td>
                                </tr>
                                <tr>
                                    <th>Remarks 3</th>
