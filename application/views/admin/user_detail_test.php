                    ...
                    <div class="panel-body">
                        <div class="detail_table">
                            <table>
                                ...
                                <tr>
                                    <th>비자 생년월일</th>
                                    <td><input class="form-control" type="text" value="<?php echo $item['date_of_birth']; ?>" name="date_of_birth" id="registration_no"></td>
                                </tr>
                                <tr>
                                    <th>구분 1</th>
                                    <td><input class="form-control" type="text" value="<?php echo $item['member_type']; ?>" name="member_type" id="type1">
                                    </td>
                                </tr>
                                <tr>
                                    <th>구분 2</th>
                                    <td> <input class="form-control" type="text" value="<?php echo $item['attendance_type']; ?>" name="attendance_type" id="type2"></td>
                                </tr>
                                <tr>
                                    <th>구분 3</th>
                                    <td><input class="form-control" type="text" value="<?php echo $item['occupation_type']; ?>" name="occupation_type" id="type2"></td>
                                </tr>
                                <tr>
                                    <th>KSSO 회원 여부</th>
                                    <td> <input type="text" class="form-control" value="<?php echo  $item['ksso_member_status']; ?>" name="ksso_member_status" id="ln"></td>
                                </tr>
                                <tr>
                                    <th>국가</th>
                                ...
                                <tr>
                                    <th>평점신청여부</th>
                                    <td> <input type="text" class="form-control" value="<?php echo $item['is_score']; ?>" name="is_score" id="ln"></td>
                                </tr>
                                <tr>
                                    <th>면허번호</th>
                                ...
                                <tr>
                                    <th>영양사면허번호</th>
                                    <td> <input type="text" class="form-control" value="<?php echo $item['nutritionist_number']; ?>" name="nutritionist_number" id="sn"></td>
                                </tr>
                                <tr>
                                    <th>임상영양사자격번호</th>
                                    <td> <input type="text" class="form-control" value="<?php echo $item['dietitian_number']; ?>" name="dietitian_number" id="sn"></td>
                                </tr>
                                <tr>
                                    <th>이름</th>
                                    <td>
                                        firstname: <input class="form-control" type="text" value="<?php echo $item['first_name']; ?>" name="first_name" id="nick_name">
                                        lastname : <input class="form-control" type="text" value="<?php echo $item['last_name']; ?>" name="last_name" id="nick_name">
                            ...
                            <table>
                                ...
                                <tr>
                                    <th>부서</th>
                                    <td> <input class="form-control" type="text" value="<?php echo $item['department']; ?>" name="department" id="org_nametag">
                                        <input class="form-control" type="text" value="<?php echo $item['department_kor']; ?>" name="department_kor" id="org_nametag">
                                    </td>
                                </tr>
                                <tr>
                                    <th>주소</th>
                                    <td> <input class="form-control" type="text" value="<?php echo $item['addr']; ?>" name="addr" id="addr">
                                    </td>
                                </tr>
                                <tr>
                                    <th>사전등록비</th>
                                ...
                                <tr>
                                    <th>입금자명</th>
                                    <td> <input class="form-control" type="text" value="<?php echo $item['deposit_name']; ?>" name="deposit_name" id="deposit_name">
                                ...
                                <tr>
                                    <th>총회 만찬식 참석 여부</th>
                                    <td> <input id="dp1" type="text" value="<?php echo $item['banquet_yn']; ?>" size="16" class="form-control" name="banquet_yn">
                                    </td>
                                </tr>
                                <tr>
                                    <th>특이식단</th>
