    ...
    <div class="content" id="nametag">
        <div id="printThis">
            <div id="editor1" contenteditable="true">
                ...
                if (mb_strlen($users['first_name']) >= 15 && mb_strlen($users['last_name']) >= 15 && $nation != "Republic of Korea") {
                    echo '<div class ="small_text_box">';

                    //한국인 X firstname & lastName 15글자 이하
                } else if (mb_strlen($users['first_name']) <= 15 && mb_strlen($users['last_name']) <= 15 && $nation != "Republic of Korea") {
