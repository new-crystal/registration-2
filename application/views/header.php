...
<div class="wrapper">
    <div class="headerWrap">
        ...
        <div class="header">        
            ...
            <div class="gnbWrap">
                <ul id="gnb">
                    <li class="<?=($this->uri->segment(1)=== null)?'on':''?>"><a href="/index.php" >인사말</a></li>
                    <li class="<?=($this->uri->segment(1)==='info')?'on':''?>"><a href="/info/" >학술행사 안내</a></li>
                    <li class="<?=($this->uri->segment(1)==='program')?'on':''?>"><a href="/program/" >프로그램</a></li>
                    <li class="<?=($this->uri->segment(1)==='registration')?'on':''?>"><a href="/registration/" >사전등록 및 확인</a></li>
                    <!--li class="<?=($this->uri->segment(1)==='submission')?'on':''?>"><a href="/submission/" >포스터 접수</a></li-->
                    <li class=" <?=($this->uri->segment(1)==='location')?'on':''?>"><a href="/location/" >오시는 길</a></li>
