                            ...
                            <fieldset>
                                <div>
                                    ...
                                    <div class="w-full flex items-center justify-center">
                                        <button type="submit" value="등록" class="btnPoint w-full flex items-center justify-center"><img class="w-1/4 mt-20" src="../../assets/images/into.png" /></button>
                                    </div>
                                </div>
...
<script>
    ...
    qrcode.addEventListener("input", (e) => {
        // 입력된 값에서 공백 제거
