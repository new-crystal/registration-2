                        ...
                        <div>
                            ...
                            <fieldset>
                                <div>
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            <ul>
                                                ...
                                                <li>
                                                    <p class="font-semibold text-lg pl-2 translate-y-2" style="color:red;">
                                                        커서를
                                                        텍스트박스 안에 놓고
                                                        QR 코드 스캐너를
                                                        사용하세요.
                                    ...
                                    <div class="border border-2 border-indigo-900 px-5 py-2 ml-2">
                                    ...
                                    <div class="w-full flex items-center justify-center">
                                        <button type="submit" value="등록" class="btnPoint w-full flex items-center justify-center"><img class="w-1/3 mt-20" src="../../assets/images/KES_logo.png" /></button>
                                    </div>
                                </div>
