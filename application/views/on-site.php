...
<form class="w-3/5 mx-auto">
    ...
    <div class="wrap_1">
        <div class="flex justify-center items-center text-white w-6/12 h-12 bg-sky-900 mx-auto mt-5 rounded-lg font-bold text-xl">
                ...
                <tr>
                    ...
                    <td>
                        <div class="flex items-center w-7/12 justify-between">
                            ...
                            <select name="Email3" id="Email3" style="background-color:#ffffff;width:100px;">
