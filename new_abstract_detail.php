...
<!--main content start-->
    <?php echo form_open('/admin/update_user?n='. $item['phone'], 'id="updateForm" name="updateForm"') ?>
...
-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" value="<?php echo $item['phone'];?>" name="phone" id="phone" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div clss="btn_group" style="float: right;">
                            <button type="submit" data-toggle="modal" class="btn btn-primary">수정</button>
                                ...
                                <a href="/admin/delete_user?d=<?php echo $item['phone'];?>" class="btn btn-danger">삭제</a>
                        </div>
                    </div>
                </div>
            </section>
